...
<div class="flex">
<div class="bg-gray-300 w-auto h-auto max-h-[60vh] p-[1.5vw] rounded-lg m-[2vh]">
    <form class="flex flex-col items-start" action="add.php" method="post">
        ...
        <button class="m-[0.5vh] w-[3.5vw] border-[1px] border-blue-700 rounded-xl h-[3vh] text-xs text-blue-600 bg-blue-100" type="submit">Enviar</button>
    </form>
    <br>
    <a class="text-blue-800 font-semibold" href="../../home.php">Página Inicial</a>
</div>
