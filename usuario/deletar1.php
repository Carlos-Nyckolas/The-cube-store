...
<body class="bg-[url('../imagens/fundo_site.png')]">
    <div class="h-[100vh] flex flex-col justify-center items-center">
        ...
        <div class="flex">
            <div class="m-[5vh] flex flex-col text-red-700 justify-around bg-gray-300 p-[5vh] rounded-xl">
                <a href="deletar2.php">EXCLUIR PERMANENTEMENTE</a>
            </div>
            <div class="m-[5vh] flex flex-col text-blue-800 justify-around bg-gray-300 p-[5vh] rounded-xl">
